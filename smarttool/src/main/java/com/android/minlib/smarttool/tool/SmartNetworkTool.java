...
public class SmartNetworkTool {

    private SmartNetworkTool() {
     ...
     * @return 网络类型
     * <ul>
     * <li>{@link SmartNetworkTool.NetworkType#NETWORK_WIFI   } </li>
     * <li>{@link SmartNetworkTool.NetworkType#NETWORK_4G     } </li>
     * <li>{@link SmartNetworkTool.NetworkType#NETWORK_3G     } </li>
     * <li>{@link SmartNetworkTool.NetworkType#NETWORK_2G     } </li>
     * <li>{@link SmartNetworkTool.NetworkType#NETWORK_UNKNOWN} </li>
