package com.android.minlib.smarttool.tool.assist;
...
public final class SystemBarTintManager {
    ...
    public SystemBarTintManager(Activity activity) {
        ...
        @SuppressLint("ResourceType") ViewGroup decorViewGroup = (ViewGroup)win.getDecorView().findViewById(16908290);
        ...
        if (this.isImmersiveMode(activity)) {
    ...
    private boolean isImmersiveMode(Activity activity) {
        try {
            int immersive = Settings.System.getInt(activity.getContentResolver(), "immersive_mode");
            if (immersive == 1) {
                return true;
            }
    ...
    public static class SystemBarConfig {
        ...
        public int getPixelInsetTop(boolean withActionBar) {
            return this.mStatusBarHeight + (withActionBar ? this.mActionBarHeight : 0);
        }
